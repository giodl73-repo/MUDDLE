...
| Browser save slots | Players can save, load, and delete named sibling save files from the browser while keeping the configured active `--save` path. |
...
- in-window named save-slot create/load/delete controls over sibling command-replay save files
